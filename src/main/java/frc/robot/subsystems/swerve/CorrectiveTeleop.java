...
public class CorrectiveTeleop {
    // based on the math here: https://www.chiefdelphi.com/t/whitepaper-swerve-drive-skew-and-second-order-kinematics/416964/18
    // uses the pose exponential and small angle approximations to compensate for the continuous movement in a discrete timestep
    
    private static final double dt = 0.16;
